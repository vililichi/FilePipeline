...
void packetSender::send(Packet& pq, sf::TcpSocket* socket_ptr, sf::Socket::Status* stat)
{
...
Packet packetSender::receive(sf::TcpSocket* socket_ptr, sf::Socket::Status* stat)
{
	size_t size = 0;
	Packet pq;
